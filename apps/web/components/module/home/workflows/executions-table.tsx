                ...
                <CardContent className="min-h-75 flex items-center justify-center border-t border-border/50 bg-muted/5 p-4">
                    ...
                    {!loading && executions.length === 0 ? (
                        <div className="flex items-center justify-center py-8 h-40 text-muted-foreground">
                            ...
                            <span className="ml-2">No executions found for this workflow.</span>
                        </div>
                    ) :
                        <div className="border border-border rounded-lg overflow-hidden w-full">
                            <table className="w-full">
                                <thead className="bg-muted/40 border-b border-border">
                                    <tr>
                                        <th className="text-left py-3 px-4 text-sm font-medium text-foreground/80">Workflow</th>
                                        <th className="text-left py-3 px-4 text-sm font-medium text-foreground/80">Status</th>
                                        <th className="text-left py-3 px-4 text-sm font-medium text-foreground/80">Started</th>
                                        <th className="text-left py-3 px-4 text-sm font-medium text-foreground/80">Run Time</th>
                                        <th className="text-left py-3 px-4 text-sm font-medium text-foreground/80">Exec. ID</th>
                                        <th className="w-8"></th>
                                    </tr>
                                </thead>
                                            ...
                                            <tr key={execution.id} className="hover:bg-muted/30">
                                                <td className="py-3 px-4">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="text-sm text-foreground">{execution.workflowName}</span>
                                                    </div>
                                                </td>
                                                <td className="py-3 px-4">
                                                    <div className="flex items-center gap-2">
