...
export default function EditorSidebar({ nodes }: Props) {
    ...
    return (
        <aside className="h-screen overflow-scroll pb-24 flex flex-col">
            <div className="p-2 text-sm font-semibold text-muted-foreground uppercase tracking-wide">Actions</div>
            <Separator />
